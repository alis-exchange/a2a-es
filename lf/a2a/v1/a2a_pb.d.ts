...
export declare type Part = Message$1<"lf.a2a.v1.Part"> & {
  ...
  content: {
    ...
    /**
     * The `raw` byte content of a file. In JSON serialization, this is encoded
     * as a base64 string.
     *
...
export declare type Message = Message$1<"lf.a2a.v1.Message"> & {
  /**
   * The unique identifier (e.g. UUID) of the message. This is created by the
   * message creator.
   *
...
export declare type Artifact = Message$1<"lf.a2a.v1.Artifact"> & {
  /**
   * Unique identifier (e.g. UUID) for the artifact. It must be unique within a
   * task.
   *
...
export declare type ListTasksRequest = Message$1<"lf.a2a.v1.ListTasksRequest"> & {
  ...
  /**
   * The maximum number of tasks to return. The service may return fewer than
   * this value. If unspecified, at most 50 tasks will be returned. The minimum
   * value is 1. The maximum value is 100.
   *
...
/**
 * Result object for `ListTasks` method containing an array of tasks and
...
export declare type ListTaskPushNotificationConfigsRequest = Message$1<"lf.a2a.v1.ListTaskPushNotificationConfigsRequest"> & {
   ...
   * `ListTaskPushNotificationConfigsRequest` call.
   *
